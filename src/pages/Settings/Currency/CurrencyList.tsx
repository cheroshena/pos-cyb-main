  ...
  const columns: ColumnsType<DataType> = [
    {
      ...
      sorter: (a, b) => {
        const currencyNameA = a.currencyName.toString();
        const currencyNameB = b.currencyName.toString();
        return currencyNameA.localeCompare(currencyNameB);
      },
    ...
    },
    {
      ...
      key: "currencyCode",
      ...getColumnSearchProps("currencyCode"),
    },

    {
      title: "Curreny Symbol",
      dataIndex: "currenySymbol",
      key: "currenySymbol",
      ...getColumnSearchProps("currenySymbol"),
    },
    {
      title: "Status",
      dataIndex: "status",
